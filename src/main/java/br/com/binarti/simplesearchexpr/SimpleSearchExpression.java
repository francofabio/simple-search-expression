...
public class SimpleSearchExpression {
	private List<SimpleSearchRelationalOperation> operations;
	
	public SimpleSearchExpression() {
	...
	public void addOperation(SimpleSearchRelationalOperation operation) {
