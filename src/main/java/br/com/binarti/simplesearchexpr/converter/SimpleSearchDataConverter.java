...
public interface SimpleSearchDataConverter {

	SimpleSearchConverterResult asObject(OperatorResolver operatorResolver, SimpleSearchExpressionField field, String value, Map<String, Object> params, Class<?> targetType) throws SimpleSearchDataConverterException;
